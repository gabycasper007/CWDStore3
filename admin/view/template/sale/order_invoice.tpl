...
<!-- <div style="page-break-after: always;"> -->
  ...
  <table class="store">
    <tr>
      <td><?php echo $order['store_name']; ?><br /><br />
        
        <?php if ($order['store_firma']) { ?>
        <?php echo $text_firma; ?> <?php echo $order['store_firma']; ?><br />
        <?php } ?>
        <?php if ($order['store_cif']) { ?>
        <?php echo $text_cif; ?> <?php echo $order['store_cif']; ?><br />
        <?php } ?>
        <?php if ($order['store_recom']) { ?>
        <?php echo $text_recom; ?> <?php echo $order['store_recom']; ?><br />
        <?php } ?>
        <?php if ($order['store_banca']) { ?>
        <?php echo $text_banca; ?> <?php echo $order['store_banca']; ?><br />
        <?php } ?>
        <?php if ($order['store_cont']) { ?>
        <?php echo $text_cont; ?> <?php echo $order['store_cont']; ?><br /><br />
        <?php } ?>
  ...
  <table class="address">
    ...
    <tr>
      <td>
        Firma: <?php echo $order['firma']; ?><br/>
        CIF: <?php echo $order['cif']; ?><br/>
        Reg.Com.: <?php echo $order['recom']; ?><br/>
        Banca: <?php echo $order['banca']; ?><br/>
        Cont: <?php echo $order['cont']; ?><br/><br/>
