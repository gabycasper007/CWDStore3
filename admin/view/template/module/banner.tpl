          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              ...
              <td class="left"><select name="banner_module[<?php echo $module_row; ?>][position]">
                  ...
                  <?php if ($module['position'] == 'content_home_square') { ?>
                      <option value="content_home_square" selected="selected"><?php echo $text_content_home_square; ?></option>
                  <?php } else { ?>
                    <option value="content_home_square"><?php echo $text_content_home_square; ?></option>
                  <?php } ?>

                  <?php if ($module['position'] == 'content_home_square_two') { ?>
                      <option value="content_home_square_two" selected="selected"><?php echo $text_content_home_square_two; ?></option>
                  <?php } else { ?>
                    <option value="content_home_square_two"><?php echo $text_content_home_square_two; ?></option>
                  <?php } ?>

                  <?php if ($module['position'] == 'content_home_longtail') { ?>
                      <option value="content_home_longtail" selected="selected"><?php echo $text_content_home_longtail; ?></option>
                  <?php } else { ?>
                    <option value="content_home_longtail"><?php echo $text_content_home_longtail; ?></option>
                  <?php } ?>
...
function addModule() {	
  ...
  html += '      <option value="content_home_square"><?php echo $text_content_home_square; ?></option>';
  html += '      <option value="content_home_square_two"><?php echo $text_content_home_square_two; ?></option>';  
  html += '      <option value="content_home_longtail"><?php echo $text_content_home_longtail; ?></option>';  
