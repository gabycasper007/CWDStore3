        ...
        <form action="<?php echo $action_link; ?>" method="post" enctype="multipart/form-data" id="searchanise_form">
          <table class="form">
            <tr>
              ...
              <td>
                <select name="searchanise_status">
                  <option value='A' <?php if ($se_status != 'D') { echo "selected"; } ?> ><?php echo $text_active; ?></option>
                  <option value='D' <?php if ($se_status == 'D') { echo "selected"; } ?> ><?php echo $text_disabled; ?></option>
                </select>
              </td>
            </tr>
            <?php if ($stores) {?>
