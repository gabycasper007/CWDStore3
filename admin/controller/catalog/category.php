...
class ControllerCatalogCategory extends Controller { 
	...
	protected function getForm() {
		...
		$this->data['entry_menu_featured_product'] = $this->language->get('entry_menu_featured_product');
		...
		$this->data['entry_promo_image'] = $this->language->get('entry_promo_image');
		...
		if (isset($this->request->post['product_menu_featured'])) {
			$products = $this->request->post['product_menu_featured'];
		} elseif (isset($this->request->get['category_id'])) {		
			$products = $this->model_catalog_product->getProductmenu_featured($this->request->get['category_id']);
		} else {
			$products = array();
		}
	
		$this->data['product_menu_featured'] = array();
		...
		if (isset($this->request->post['icon_image'])) {
			$this->data['icon_image'] = $this->request->post['icon_image'];
		} elseif (!empty($category_info)) {
			$this->data['icon_image'] = $category_info['icon_image'];
		} else {
			$this->data['icon_image'] = '';
		}

		if (isset($this->request->post['promo_image'])) {
			$this->data['promo_image'] = $this->request->post['promo_image'];
		} elseif (!empty($category_info)) {
			$this->data['promo_image'] = $category_info['promo_image'];
		} else {
			$this->data['promo_image'] = '';
		}
		...
		if (isset($this->request->post['icon_image']) && file_exists(DIR_IMAGE . $this->request->post['icon_image'])) {
			$this->data['icon'] = $this->model_tool_image->resize($this->request->post['icon_image'], 100, 100);
		} elseif (!empty($category_info) && $category_info['icon_image'] && file_exists(DIR_IMAGE . $category_info['icon_image'])) {
			$this->data['icon'] = $this->model_tool_image->resize($category_info['icon_image'], 100, 100);
		} else {
			$this->data['icon'] = $this->model_tool_image->resize('no_image.jpg', 100, 100);
		}

		if (isset($this->request->post['promo_image']) && file_exists(DIR_IMAGE . $this->request->post['promo_image'])) {
			$this->data['promo'] = $this->model_tool_image->resize($this->request->post['promo_image'], 100, 100);
		} elseif (!empty($category_info) && $category_info['promo_image'] && file_exists(DIR_IMAGE . $category_info['promo_image'])) {
			$this->data['promo'] = $this->model_tool_image->resize($category_info['promo_image'], 100, 100);
		} else {
			$this->data['promo'] = $this->model_tool_image->resize('no_image.jpg', 100, 100);
		}
