...
class ModelSaleOrder extends Model {
	public function addOrder($data) {
		...
		$store_firma = $store_info['firma'];
		$store_cif = $store_info['cif'];
		$store_recom = $store_info['recom'];
		$store_banca = $store_info['banca'];
		$store_cont = $store_info['cont'];
		...
		if ($currency_info) {
      	...
      	$this->db->query("INSERT INTO `" . DB_PREFIX . 
      		"order` SET invoice_prefix = '" . $this->db->escape($invoice_prefix) . 
      		"', store_id = '" . (int)$data['store_id'] . 
      		"', store_name = '" . $this->db->escape($store_name) . 
      		"',store_url = '" . $this->db->escape($store_url) .

      		"',store_firma = '" . $this->db->escape($store_firma) .
      		"',store_cif = '" . $this->db->escape($store_cif) .
      		"',store_recom = '" . $this->db->escape($store_recom) .
      		"',store_banca = '" . $this->db->escape($store_banca) .
      		"',store_cif = '" . $this->db->escape($store_cif) .
      		...
      		"', currency_code = '" . $this->db->escape($currency_code) . "', currency_value = '" . (float)$currency_value . "', date_added = NOW(), date_modified = NOW()");
	...
	public function editOrder($order_id, $data) {
		...
		if ($order_query->num_rows) {
      	...
      	$this->db->query("UPDATE `" . DB_PREFIX . 
      		"order` SET firstname = '" . $this->db->escape($data['firstname']) . 
      		"', lastname = '" . $this->db->escape($data['lastname']) . 
      		"', email = '" . $this->db->escape($data['email']) . 
      		"', telephone = '" . $this->db->escape($data['telephone']) . 
      		"', fax = '" . $this->db->escape($data['fax']) .
