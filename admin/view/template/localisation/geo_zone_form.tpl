        ...
        <table id="zone-to-geo-zone" class="list">
          ...
          <tbody id="zone-to-geo-zone-row<?php echo $zone_to_geo_zone_row; ?>">
            <tr>
              ...
              <td class="left"><a onclick="$('#zone-to-geo-zone-row<?php echo $zone_to_geo_zone_row; ?>').remove();" class="button button-caution"><?php echo $button_remove; ?></a></td>
            </tr>
          </tbody>
...
function addGeoZone() {
	...
	html += '<td class="left"><a onclick="$(\'#zone-to-geo-zone-row' + zone_to_geo_zone_row + '\').remove();" class="button button-caution"><?php echo $button_remove; ?></a></td>';
	html += '</tr>';
	html += '</tbody>';
