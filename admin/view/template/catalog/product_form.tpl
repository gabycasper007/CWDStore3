...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/stock-status.png" alt="" />
          <?php echo $heading_title . ' - ';
              foreach ($languages as $language) {
                echo isset($product_description[$language['language_id']]) ? utf8_substr($product_description[$language['language_id']]['name'], 0, 50) : '';
              }
              echo ' (' . $model . ')'; ?>
      </h1>
      <div class="buttons">
        ...
        <?php
          ...
          if (isset($product_id)) $product_store = $this->model_catalog_product->getProductStores($product_id);
          ...
          if (in_array(0, $product_store)) { ?>
            <a class="button button-highlight"
               ...
               href="<?php echo $store 
                          ...
                          . $product_id; ?>"><?php echo $text_view_in_store; //basename($store); ?></a>
            <?php 
          } ?>
        <a href="<?php echo $cancel; ?>" class="button button-caution"><?php echo $button_cancel; ?></a>
      </div>
    </div>
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-links"><?php echo $tab_links; ?></a><a href="#tab-attribute"><?php echo $tab_attribute; ?></a><a href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-discount"><?php echo $tab_discount; ?></a><a href="#tab-special"><?php echo $tab_special; ?></a><a href="#tab-image"><?php echo $tab_image; ?></a><a href="#tab-reward"><?php echo $tab_reward; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a><a href="#tab-product_tab"><?php echo $tab_product_tab; ?></a></div>
      <br /><br />
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              ...
              <tr>
                <td>
                  <?php echo $entry_resigilate; ?>
                </td>
                <td><input type="text" 
                  name="product_description[<?php echo $language['language_id']; ?>][desc_resigilate]" 
                  value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['desc_resigilate'] : ''; ?>"
                  size="100"></td>
              </tr>
              <tr>
              ...
              <tr class="nobdb">
                <td><?php echo $entry_shortdesc; ?></td>
                <td><textarea name="product_description[<?php echo $language['language_id']; ?>][shortdesc]" id="shortdesc<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['shortdesc'] : ''; ?></textarea></td>
              </tr>
              <tr>
                <td colspan="2"><h2 class="nobdb">SEO</h2></td>
              </tr>
              <tr><!-- uuu tr added -->
                <td> 
                  <?php echo $text_title_document; ?>
                  <br />
                  <span class = "help"><?php echo $text_title_document_description; ?></span>
                </td>
              ...
              <tr><!-- uuu tr added -->
                <td> 
                  <?php echo $text_heading_1; ?>
                  <br />
                  <span class = "help"><?php echo $text_heading_1_description; ?></span>
                </td>
              ...
              <tr>
                <td> 
                  <?php echo $text_heading_2; ?>
                  <br />
                  <span class = "help"><?php echo $text_heading_2_description; ?></span>
                </td>
              ...
              <tr> <!-- tr uuu added -->
                <td>
                  <?php echo $text_change_meta_tags; ?>
                  <br />
                  <span class = "help"><?php echo $text_change_meta_tags_description; ?> </span>
                </td>
                <td>
        ...
        <div id="tab-data">
          <table class="form">
            <tr>
              <td colspan="7"><h2 class="nobdb"><?php echo $entry_title_models ?></h2></td>
            </tr>
            <tr>
              <td><span class="required">*</span> <?php echo $entry_model; ?></td>
              <td colspan="5"><input type="text" name="model" value="<?php echo $model; ?>" />
                <?php if ($error_model) { ?>
            ...
            <tr class="nobdb">
              ...
              <td colspan="5"><input type="text" name="location" value="<?php echo $location; ?>" /></td>
            </tr>

            <tr>
              <td colspan="6"><h2 class="nobdb"><?php echo $entry_title_prices ?></h2></td>
            </tr>
            ...
            <tr class="bdt">
              ...
              <td colspan="3"><select name="tax_class_id">
            ...
            <tr>
              ...
              <td colspan="3"><input type="text" name="minimum" value="<?php echo $minimum; ?>" size="2" /></td>
            </tr>
            <tr>
            ...
            <tr class="nobdb">
              ...
              <td colspan="5"><div class="image"><img src="<?php echo $thumb; ?>" alt="" id="thumb" /><br />
                  <input type="hidden" name="image" value="<?php echo $image; ?>" id="image" />
                  <a onclick="image_upload('image', 'thumb');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb').attr('src', '<?php echo $no_image; ?>'); $('#image').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
            </tr>

            <tr>
              <td colspan="7"><h2 class="nobdb"><?php echo $entry_title_availability ?></h2></td>
            </tr>
            ...
            <!-- <tr>
              <td><?php echo $entry_home_sort_order; ?></td>
              <td colspan="3"><input type="text" name="home_sort_order" value="<?php echo $home_sort_order; ?>" size="2" /></td>
            </tr> -->
              
            <tr>
              <td colspan="6"><h2 class="nobdb"><?php echo $entry_title_dimensions; ?></h2></td>
            </tr>
            ...
            <tr>
              ...
              <td colspan="3"><select name="length_class_id">
            ...
            <tr>
              ...
              <td colspan="3"><select name="weight_class_id">
            ...
            <tbody id="attribute-row<?php echo $attribute_row; ?>">
              <tr>
                ...
                <td class="left"><?php foreach ($languages as $language) { ?>
                  ...
                  <?php } ?></td>
                <td class="left"><a onclick="$('#attribute-row<?php echo $attribute_row; ?>').remove();" class="button button-caution"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $attribute_row++; ?>
            <?php } ?>
        ...
        <div id="tab-option">
          ...
          <div id="tab-option-<?php echo $option_row; ?>" class="vtabs-content">
            ...
            <table class="form">
              ...
              <tr>
                <td><?php echo $heading_option_description; ?></td>
            ...
            <table id="option-value<?php echo $option_row; ?>" class="list">
              <thead>
                <tr>
                  ...
                  <td class="left"><?php echo $entry_option_description; ?></td>
                  ...
                  <!-- <td class="right"><?php echo $entry_alldb; ?></td> -->
                  <td></td>
                </tr>
              </thead>
              ...
              <tbody id="option-value-row<?php echo $option_value_row; ?>">
                <tr>
                  ...
                  <td>
                    <textarea name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][o_description]" cols="30" rows="1"><?php echo $product_option_value['o_description']; ?></textarea>
                  </td>
                  ...
                  <!-- <td class="left">
                    <select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][alldb]">

                        <?php if ($product_option_value['alldb'] == '1') { ?>
                            <option value="1" selected="selected">Niciuna</option>
                        <?php } else { ?>
                            <option value="1">Niciuna</option>
                        <?php } ?>

                        <?php if ($product_option_value['alldb'] == '2') { ?>
                            <option value="2" selected="selected">Noi</option>
                        <?php } else { ?>
                            <option value="2">Noi</option>
                        <?php } ?>

                        <?php if ($product_option_value['alldb'] == '3') { ?>
                            <option value="3" selected="selected">Toate</option>
                        <?php } else { ?>
                  ...
                  <td class="left"><a onclick="$('#option-value-row<?php echo $option_value_row; ?>').remove();" class="button button-caution"><?php echo $button_remove; ?></a></td>
                </tr>
              </tbody>
              ...
              <tfoot>
                <tr>
                  <td colspan="6"></td>
                  <td class="right" colspan="3"><a onclick="addOptionValue('<?php echo $option_row; ?>');" class="button"><?php echo $button_add_option_value; ?></a></td>
                </tr>
              </tfoot>
            </table>
          ...
          <table id="discount" class="list">
            ...
            <tbody id="discount-row<?php echo $discount_row; ?>">
              <tr>
                ...
                <td class="left"><a onclick="$('#discount-row<?php echo $discount_row; ?>').remove();" class="button button-caution"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $discount_row++; ?>
            <?php } ?>
          ...
          <table id="special" class="list">
            ...
            <tbody id="special-row<?php echo $special_row; ?>">
              <tr>
                ...
                <td class="left"><a onclick="$('#special-row<?php echo $special_row; ?>').remove();" class="button button-caution"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $special_row++; ?>
            <?php } ?>
          ...
          <table id="images" class="list">
            ...
            <tbody id="image-row<?php echo $image_row; ?>">
              <tr>
                ...
                <td class="left"><a onclick="$('#image-row<?php echo $image_row; ?>').remove();" class="button button-caution"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $image_row++; ?>
            <?php } ?>
...
CKEDITOR.replace('shortdesc<?php echo $language['language_id']; ?>', {
  filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
  filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
  filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
  filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
...
function addAttribute() {
    ...
    <?php } ?>
	html += '    </td>';
	html += '    <td class="left"><a onclick="$(\'#attribute-row' + attribute_row + '\').remove();" class="button button-caution"><?php echo $button_remove; ?></a></td>';
    html += '  </tr>';	
    html += '</tbody>';
...
$('input[name=\'option\']').catcomplete({
	...
	select: function(event, ui) {
      ...
      html += '        <td class="left"><?php echo $entry_option_description; ?></td>'
...
function addOptionValue(option_row) {	
  ...
  html += '  <td><textarea name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][o_description]" cols="40" rows="5"></textarea></td>'
  ...
  html += '      <option value="%">%</option>';
	...
	html += '    <td class="left"><a onclick="$(\'#option-value-row' + option_value_row + '\').remove();" class="button button-caution"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
	html += '</tbody>';
...
function addDiscount() {
	...
	html += '    <td class="left"><a onclick="$(\'#discount-row' + discount_row + '\').remove();" class="button button-caution"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';	
    html += '</tbody>';
...
function addSpecial() {
	...
	html += '    <td class="left"><a onclick="$(\'#special-row' + special_row + '\').remove();" class="button button-caution"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
    html += '</tbody>';
...
function addImage() {
	...
	html += '    <td class="left"><a onclick="$(\'#image-row' + image_row  + '\').remove();" class="button button-caution"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
	html += '</tbody>';
