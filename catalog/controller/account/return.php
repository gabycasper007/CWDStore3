...
class ControllerAccountReturn extends Controller { 
	...
	public function index() {
		...
		$this->data['text_logged_s'] = $this->customer->getFirstName();
	...
	public function info() {
		...
		if ($return_info) {
			...
			$this->data['firma'] = $return_info['firma'];	
			$this->data['cif'] = $return_info['cif'];	
			$this->data['recom'] = $return_info['recom'];	
			$this->data['banca'] = $return_info['banca'];	
			$this->data['cont'] = $return_info['cont'];
	...
	public function insert() {
		...
		if (isset($this->request->post['firma'])) {
			...
			$this->data['firma'] = $this->customer->getFirstName();
		}
		if (isset($this->request->post['cif'])) {
			...
			$this->data['cif'] = $this->customer->getFirstName();
		}
		if (isset($this->request->post['recom'])) {
			...
			$this->data['recom'] = $this->customer->getFirstName();
		}
		if (isset($this->request->post['banca'])) {
			...
			$this->data['banca'] = $this->customer->getFirstName();
		}
		if (isset($this->request->post['cont'])) {
			...
			$this->data['cont'] = $this->customer->getLastName();
		}
