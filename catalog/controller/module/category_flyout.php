...
class ControllerModuleCategoryFlyout extends Controller {
	protected function index($setting) {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/category_flyout.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/module/category_flyout.tpl';
		} else {
			$this->template = 'default/template/module/category_flyout.tpl';
		}
