...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1>
        <img src="view/image/order.png" alt="" /> <?php echo $heading_title; ?>
      </h1>

      <div class="buttons">
        <a onclick="window.open('<?php echo $invoice; ?>&pdf=true');" class="button button-action"><?php echo $button_pdf_invoice; ?></a>
        <a href="<?php echo $invoice; ?>" target="_blank" class="button button-highlight"><?php echo $button_invoice; ?></a>
    ...
    <div class="content">
      ...
      <div id="tab-order" class="vtabs-content">
        <table class="form">
          ...
          <?php if ($firma) { ?>
          <tr>
            <td><?php echo $text_firma; ?></td>
            <td><?php echo $firma; ?></td>
          </tr>
          <?php } ?>
          <?php if ($cif) { ?>
          <tr>
            <td><?php echo $text_cif; ?></td>
            <td><?php echo $cif; ?></td>
          </tr>
          <?php } ?>
          <?php if ($recom) { ?>
          <tr>
            <td><?php echo $text_recom; ?></td>
            <td><?php echo $recom; ?></td>
          </tr>
          <?php } ?>
          <?php if ($banca) { ?>
          <tr>
            <td><?php echo $text_banca; ?></td>
            <td><?php echo $banca; ?></td>
          </tr>
          <?php } ?>
          <?php if ($cont) { ?>
          <tr>
            <td><?php echo $text_cont; ?></td>
            <td><?php echo $cont; ?></td>
          </tr>
          <?php } ?>
            ...
            <?php foreach ($products as $product) { ?>
              ...
              <tr>
                <td class="left"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
                  ...
                  <?php } ?>
                  <?php } ?></td>
                <td><img src="<?php echo HTTPS_CATALOG."image/".$productinfo->row['image']; ?>" width="60" height="60" /></td>
