...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$this->data['text_smtp'] = $this->language->get('text_smtp');
			...
			$this->data['entry_harta'] = $this->language->get('entry_harta');
			$this->data['entry_email'] = $this->language->get('entry_email');
			$this->data['entry_telephone'] = $this->language->get('entry_telephone');
			$this->data['entry_fax'] = $this->language->get('entry_fax');
			$this->data['entry_tech'] = $this->language->get('entry_tech');
			$this->data['entry_infoline'] = $this->language->get('entry_infoline');

		$this->data['entry_firma'] = $this->language->get('entry_firma');
		$this->data['entry_cif'] = $this->language->get('entry_cif');
		$this->data['entry_recom'] = $this->language->get('entry_recom');
		$this->data['entry_banca'] = $this->language->get('entry_banca');
		$this->data['entry_cont'] = $this->language->get('entry_cont');

		$this->data['entry_title'] = $this->language->get('entry_title');

			$this->data['entry_slogan'] = $this->language->get('entry_slogan');
			$this->data['entry_mesaj'] = $this->language->get('entry_mesaj');
		...
		$this->data['entry_related_limit'] = $this->language->get('entry_related_limit');
		...
		$this->data['entry_icon_image_category'] = $this->language->get('entry_icon_image_category');
		$this->data['entry_image_sub_category'] = $this->language->get('entry_image_sub_category');
		...
		$this->data['tab_live_update'] = $this->language->get('tab_live_update');
		$this->data['heading_title_live_update'] = $this->language->get('heading_title_live_update');
		$this->data['entry_live_update_enable'] = $this->language->get('entry_live_update_enable');
		$this->data['entry_output'] = $this->language->get('entry_output');
		$this->data['text_output_page'] = $this->language->get('text_output_page');
		$this->data['text_output_popup'] = $this->language->get('text_output_popup');
		$this->data['text_output_both'] = $this->language->get('text_output_both');
		$this->data['entry_price'] = $this->language->get('entry_price');
		$this->data['entry_weight'] = $this->language->get('entry_weight');
		$this->data['entry_point'] = $this->language->get('entry_point');
		$this->data['entry_discount'] = $this->language->get('entry_discount');
		$this->data['entry_live_update_price'] = $this->language->get('entry_live_update_price');
		$this->data['entry_live_update_special_price'] = $this->language->get('entry_live_update_special_price');
		$this->data['entry_live_update_price_excluding_tax'] = $this->language->get('entry_live_update_price_excluding_tax');
		$this->data['entry_live_update_price_in_reward_points'] = $this->language->get('entry_live_update_price_in_reward_points');
		$this->data['entry_live_update_weight'] = $this->language->get('entry_live_update_weight');
		$this->data['entry_live_update_points'] = $this->language->get('entry_live_update_points');
		$this->data['entry_show_pricevalue_with_option'] = $this->language->get('entry_show_pricevalue_with_option');
		$this->data['entry_hide_prefix_of_option_value'] = $this->language->get('entry_hide_prefix_of_option_value');
		$this->data['entry_live_update_price_with_qty'] = $this->language->get('entry_live_update_price_with_qty');
		$this->data['entry_live_update_special_price_with_qty'] = $this->language->get('entry_live_update_special_price_with_qty');
		$this->data['entry_live_update_price_excluding_tax_with_qty'] = $this->language->get('entry_live_update_price_excluding_tax_with_qty');
		$this->data['entry_live_update_price_in_reward_points_with_qty'] = $this->language->get('entry_live_update_price_in_reward_points_with_qty');
		$this->data['entry_live_update_weight_with_qty'] = $this->language->get('entry_live_update_weight_with_qty');
		$this->data['entry_live_update_points_with_qty'] = $this->language->get('entry_live_update_points_with_qty');
		$this->data['entry_live_update_discount'] = $this->language->get('entry_live_update_discount');
		$this->data['entry_show_weight'] = $this->language->get('entry_show_weight');
		$this->data['entry_show_option_weight'] = $this->language->get('entry_show_option_weight');
		$this->data['entry_hide_prefix_of_option_weight'] = $this->language->get('entry_hide_prefix_of_option_weight');
		$this->data['entry_show_option_point'] = $this->language->get('entry_show_option_point');
		$this->data['entry_hide_prefix_of_option_point'] = $this->language->get('entry_hide_prefix_of_option_point');
		$this->data['entry_show_weight_decimal_place'] = $this->language->get('entry_show_weight_decimal_place');
		...
		if (isset($this->error['telephone'])) {
 		...
 		if (isset($this->error['icon_image_category'])) {
			$this->data['error_icon_image_category'] = $this->error['icon_image_category'];
		} else {
			$this->data['error_icon_image_category'] = '';
		}
		...
		if (isset($this->error['related_limit'])) {
			$this->data['error_related_limit'] = $this->error['related_limit'];
		} else {
			$this->data['error_related_limit'] = '';
		}
		...
		if (isset($this->request->post['config_harta'])) {
			$this->data['config_harta'] = $this->request->post['config_harta'];
		} else {
			$this->data['config_harta'] = $this->config->get('config_harta');
		}
		...
		if (isset($this->request->post['config_tech'])) {
			$this->data['config_tech'] = $this->request->post['config_tech'];
		} else {
			$this->data['config_tech'] = $this->config->get('config_tech');
		}
		if (isset($this->request->post['config_infoline'])) {
			$this->data['config_infoline'] = $this->request->post['config_infoline'];
		} else {
			$this->data['config_infoline'] = $this->config->get('config_infoline');
		}

		// Additional store info
			if (isset($this->request->post['config_firma'])) {
				$this->data['config_firma'] = $this->request->post['config_firma'];
			} else {
				$this->data['config_firma'] = $this->config->get('config_firma');
			}
			if (isset($this->request->post['config_cif'])) {
				$this->data['config_cif'] = $this->request->post['config_cif'];
			} else {
				$this->data['config_cif'] = $this->config->get('config_cif');
			}
			if (isset($this->request->post['config_recom'])) {
				$this->data['config_recom'] = $this->request->post['config_recom'];
			} else {
				$this->data['config_recom'] = $this->config->get('config_recom');
			}
			if (isset($this->request->post['config_banca'])) {
				$this->data['config_banca'] = $this->request->post['config_banca'];
			} else {
				$this->data['config_banca'] = $this->config->get('config_banca');
			}
			if (isset($this->request->post['config_cont'])) {
				$this->data['config_cont'] = $this->request->post['config_cont'];
			} else {
				$this->data['config_cont'] = $this->config->get('config_cont');
			}
			...
			if (isset($this->request->post['config_mesaj'])) {
				$this->data['config_mesaj'] = $this->request->post['config_mesaj'];
			} else {
				$this->data['config_mesaj'] = $this->config->get('config_mesaj');
			}						
		//end additional store info
		...
		if (isset($this->request->post['config_live_update'])) {$this->data['config_live_update'] = $this->request->post['config_live_update'];} else {$this->data['config_live_update'] = $this->config->get('config_live_update');}

		if (isset($this->request->post['config_live_update_output'])) {$this->data['config_live_update_output'] = $this->request->post['config_live_update_output'];} else {$this->data['config_live_update_output'] = $this->config->get('config_live_update_output');}

		if (isset($this->request->post['config_live_update_price'])) {$this->data['config_live_update_price'] = $this->request->post['config_live_update_price'];} else {$this->data['config_live_update_price'] = $this->config->get('config_live_update_price');}

		if (isset($this->request->post['config_live_update_special_price'])) {$this->data['config_live_update_special_price'] = $this->request->post['config_live_update_special_price'];} else {$this->data['config_live_update_special_price'] = $this->config->get('config_live_update_special_price');}

		if (isset($this->request->post['config_live_update_price_excluding_tax'])) {$this->data['config_live_update_price_excluding_tax'] = $this->request->post['config_live_update_price_excluding_tax'];} else {$this->data['config_live_update_price_excluding_tax'] = $this->config->get('config_live_update_price_excluding_tax');}

		if (isset($this->request->post['config_live_update_price_in_reward_points'])) {$this->data['config_live_update_price_in_reward_points'] = $this->request->post['config_live_update_price_in_reward_points'];} else {$this->data['config_live_update_price_in_reward_points'] = $this->config->get('config_live_update_price_in_reward_points');}
					
		if (isset($this->request->post['config_live_update_weight'])) {$this->data['config_live_update_weight'] = $this->request->post['config_live_update_weight'];} else {$this->data['config_live_update_weight'] = $this->config->get('config_live_update_weight');}

		if (isset($this->request->post['config_live_update_points'])) {$this->data['config_live_update_points'] = $this->request->post['config_live_update_points'];} else {$this->data['config_live_update_points'] = $this->config->get('config_live_update_points');}

		if (isset($this->request->post['config_live_show_pricevalue_with_option'])) {$this->data['config_live_show_pricevalue_with_option'] = $this->request->post['config_live_show_pricevalue_with_option'];} else {$this->data['config_live_show_pricevalue_with_option'] = $this->config->get('config_live_show_pricevalue_with_option');}

		if (isset($this->request->post['config_live_hide_prefix_of_option_value'])) {$this->data['config_live_hide_prefix_of_option_value'] = $this->request->post['config_live_hide_prefix_of_option_value'];} else {$this->data['config_live_hide_prefix_of_option_value'] = $this->config->get('config_live_hide_prefix_of_option_value');}

		if (isset($this->request->post['config_live_update_price_with_qty'])) {$this->data['config_live_update_price_with_qty'] = $this->request->post['config_live_update_price_with_qty'];} else {$this->data['config_live_update_price_with_qty'] = $this->config->get('config_live_update_price_with_qty');}

		if (isset($this->request->post['config_live_update_special_price_with_qty'])) {$this->data['config_live_update_special_price_with_qty'] = $this->request->post['config_live_update_special_price_with_qty'];} else {$this->data['config_live_update_special_price_with_qty'] = $this->config->get('config_live_update_special_price_with_qty');}

		if (isset($this->request->post['config_live_update_price_excluding_tax_with_qty'])) {$this->data['config_live_update_price_excluding_tax_with_qty'] = $this->request->post['config_live_update_price_excluding_tax_with_qty'];} else {$this->data['config_live_update_price_excluding_tax_with_qty'] = $this->config->get('config_live_update_price_excluding_tax_with_qty');}

		if (isset($this->request->post['config_live_update_price_in_reward_points_with_qty'])) {$this->data['config_live_update_price_in_reward_points_with_qty'] = $this->request->post['config_live_update_price_in_reward_points_with_qty'];} else {$this->data['config_live_update_price_in_reward_points_with_qty'] = $this->config->get('config_live_update_price_in_reward_points_with_qty');}

		if (isset($this->request->post['config_live_update_weight_with_qty'])) {$this->data['config_live_update_weight_with_qty'] = $this->request->post['config_live_update_weight_with_qty'];} else {$this->data['config_live_update_weight_with_qty'] = $this->config->get('config_live_update_weight_with_qty');}


		if (isset($this->request->post['config_live_update_discount'])) {$this->data['config_live_update_discount'] = $this->request->post['config_live_update_discount'];} else {$this->data['config_live_update_discount'] = $this->config->get('config_live_update_discount');}

		if (isset($this->request->post['config_live_show_weight'])) {$this->data['config_live_show_weight'] = $this->request->post['config_live_show_weight'];} else {$this->data['config_live_show_weight'] = $this->config->get('config_live_show_weight');}

		if (isset($this->request->post['config_live_show_option_weight'])) {$this->data['config_live_show_option_weight'] = $this->request->post['config_live_show_option_weight'];} else {$this->data['config_live_show_option_weight'] = $this->config->get('config_live_show_option_weight');}

		if (isset($this->request->post['config_live_hide_prefix_of_option_weight'])) {$this->data['config_live_hide_prefix_of_option_weight'] = $this->request->post['config_live_hide_prefix_of_option_weight'];} else {$this->data['config_live_hide_prefix_of_option_weight'] = $this->config->get('config_live_hide_prefix_of_option_weight');}

		if (isset($this->request->post['config_live_show_weight_decimal_place'])) {$this->data['config_live_show_weight_decimal_place'] = $this->request->post['config_live_hide_prefix_of_option_weight'];} else {$this->data['config_live_show_weight_decimal_place'] = $this->config->get('config_live_show_weight_decimal_place');}

		if (isset($this->request->post['config_live_show_option_point'])) {$this->data['config_live_show_option_point'] = $this->request->post['config_live_show_option_point'];} else {$this->data['config_live_show_option_point'] = $this->config->get('config_live_show_option_point');}

		if (isset($this->request->post['config_live_hide_prefix_of_option_point'])) {$this->data['config_live_hide_prefix_of_option_point'] = $this->request->post['config_live_hide_prefix_of_option_point'];} else {$this->data['config_live_hide_prefix_of_option_point'] = $this->config->get('config_live_hide_prefix_of_option_point');}
		...
		if (isset($this->request->post['config_related_limit'])) {
			$this->data['config_related_limit'] = $this->request->post['config_related_limit'];
		} else {
			$this->data['config_related_limit'] = $this->config->get('config_related_limit');
		}
		...
		if (isset($this->request->post['config_icon_image_category_width'])) {
			$this->data['config_icon_image_category_width'] = $this->request->post['config_icon_image_category_width'];
		} else {
			$this->data['config_icon_image_category_width'] = $this->config->get('config_icon_image_category_width');
		}

		if (isset($this->request->post['config_icon_image_category_height'])) {
			$this->data['config_icon_image_category_height'] = $this->request->post['config_icon_image_category_height'];
		} else {
			$this->data['config_icon_image_category_height'] = $this->config->get('config_icon_image_category_height');
		}
		...
		if (isset($this->request->post['config_image_sub_category_width'])) {
			...
			$this->data['config_image_sub_category_width'] = $this->config->get('config_image_sub_category_width');
		}
		...
		if (isset($this->request->post['config_image_sub_category_height'])) {
			...
			$this->data['config_image_sub_category_height'] = $this->config->get('config_image_sub_category_height');
		}
	...
	protected function validate() {
		...
		if (!$this->request->post['config_related_limit']) {
			$this->error['related_limit'] = $this->language->get('error_limit');
		}
