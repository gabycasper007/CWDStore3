          ...
          <tbody id="option-value-row<?php echo $option_value_row; ?>">
            ...
            <tr>
              ...
              <td class="left">
                ...
                <div id="language-<?php echo $option_value_row; ?>" class="htabs">



                  <?php foreach ($languages as $language) { ?>

                    <a href="#tab-language-<?php echo $option_value_row; ?>-<?php echo $language['language_id']; ?>"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a>
                ...
                <?php foreach ($languages as $language) { ?>
                  ...
                  <div id="tab-language-<?php echo $option_value_row; ?>-<?php echo $language['language_id']; ?>">

                    <textarea name="option_value[<?php echo $option_value_row; ?>][option_value_description][<?php 

                                                       echo $language['language_id']; ?>][description]"          

                              id="description-<?php echo $option_value_row; ?>-<?php echo $language['language_id']; ?>">

                      <?php echo isset($option_value['option_value_description'][$language['language_id']]) ? $option_value['option_value_description'][$language['language_id']]['description'] : ''; ?>
...
function addOptionValue() {
  ...
  html += '<td class="left">';
      ...
      html += '  <div id="language-' + option_value_row + '" class="htabs">';

      <?php foreach ($languages as $language) { ?>

      html += '    <a href="#tab-language-'+ option_value_row + '-<?php echo $language['language_id']; ?>"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a>';
      ...
      html += '    <div id="tab-language-'+ option_value_row + '-<?php echo $language['language_id']; ?>">';

      html += '      <textarea name="option_value[' + option_value_row + '][option_value_description][<?php echo $language['language_id']; ?>][description]" id="description-' + option_value_row + '-<?php echo $language['language_id']; ?>"></textarea>';
  ...
  <?php foreach ($languages as $language) { ?>
    ...
    CKEDITOR.replace('description-' + option_value_row + '-<?php echo $language['language_id']; ?>', {
  ...
  $('#language-' + option_value_row + ' a').tabs();
...
<script type="text/javascript"><!--
  ...
  CKEDITOR.replace('description-<?php echo $option_value_row; ?>-<?php echo $language['language_id']; ?>', {
  ...
  $('#language-<?php echo $option_value_row; ?> a').tabs();
