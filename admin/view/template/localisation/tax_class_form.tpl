        ...
        <table id="tax-rule" class="list">
          ...
          <tbody id="tax-rule-row<?php echo $tax_rule_row; ?>">
            <tr>
              ...
              <td class="left"><a onclick="$('#tax-rule-row<?php echo $tax_rule_row; ?>').remove();" class="button button-caution"><?php echo $button_remove; ?></a></td>
            </tr>
          </tbody>
          <?php $tax_rule_row++; ?>
          <?php } ?>
...
function addRule() {
	...
	html += '    <td class="left"><a onclick="$(\'#tax-rule-row' + tax_rule_row + '\').remove();" class="button button-caution"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
	html += '</tbody>';
