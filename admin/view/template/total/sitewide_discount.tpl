                    ...
                    <tr>
                        ...
                        <td>
                            <select name="sitewide_discount_type" id="sitewide_discount_type">
                                <option value="F" <?php echo ($sitewide_discount_type == "F" ? "selected='selected'" : ""); ?>>Fixed Value</option>
                                <option value="P" <?php echo ($sitewide_discount_type == "P" ? "selected='selected'" : ""); ?>>Percentage</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
