...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-store"><?php echo $tab_store; ?></a><a href="#tab-local"><?php echo $tab_local; ?></a><a href="#tab_live_update"><?php echo $tab_live_update; ?></a><a href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-image"><?php echo $tab_image; ?></a><a href="#tab-ftp"><?php echo $tab_ftp; ?></a><a href="#tab-mail"><?php echo $tab_mail; ?></a><a href="#tab-fraud"><?php echo $tab_fraud; ?></a><a href="#tab-server"><?php echo $tab_server; ?></a></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          <table class="form">
            ...
            <tr>
              <td><span class="required">*</span> <?php echo $entry_harta; ?></td>
              <td><textarea name="config_harta" cols="40" rows="5"><?php echo $config_harta; ?></textarea></td>
            </tr>
            ...
            <tr>
             ...
             <tr>
              <td><?php echo $entry_tech; ?></td>
              <td><input type="text" name="config_tech" value="<?php echo $config_tech; ?>"  size="40" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_infoline; ?></td>
              <td><input type="text" name="config_infoline" value="<?php echo $config_infoline; ?>"  size="40" /></td>
            </tr>
            ...
            <tr>
              <td><?php echo $entry_firma; ?></td>
              <td><input type="text" name="config_firma" value="<?php echo $config_firma; ?>"  size="40" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_cif; ?></td>
              <td><input type="text" name="config_cif" value="<?php echo $config_cif; ?>"  size="40" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_recom; ?></td>
              <td><input type="text" name="config_recom" value="<?php echo $config_recom; ?>"  size="40" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_banca; ?></td>
              <td><input type="text" name="config_banca" value="<?php echo $config_banca; ?>"  size="40" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_cont; ?></td>
              <td><input type="text" name="config_cont" value="<?php echo $config_cont; ?>"  size="40" /></td>
            </tr>
        ...
        <div id="tab-store">
          <table class="form">
            ...
            <tr>
              <td><?php echo $entry_slogan; ?></td>
              <td><input type="text" name="config_slogan" value="<?php echo $config_slogan; ?>" size="40" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_mesaj; ?></td>
              <td><input type="text" name="config_mesaj" value="<?php echo $config_mesaj; ?>" size="40" /></td>
            </tr>
        ...
        <div id="tab_live_update">
          <h2><?php echo $entry_live_update_enable; ?><input type="radio" name="config_live_update" value="1" <?php if($config_live_update==1){ echo "checked";}?> /> <?php echo $text_yes; ?> <input type="radio" name="config_live_update" value="0" <?php if($config_live_update==0){ echo "checked";}?> /> <?php echo $text_no; ?>
        </h2>
          <?php if($config_live_update==1){?>
          <hr />
          <span><?php echo $entry_output; ?><select name="config_live_update_output">
            <?php if(!$config_live_update_output){?>
            <option value="0" selected><?php echo $text_output_page; ?></option>
            <option value="1"><?php echo $text_output_popup; ?></option>
            <option value="2"><?php echo $text_output_both; ?></option>
            <?php } else {?>
                <?php if($config_live_update_output==0){?>
                <option value="0" selected><?php echo $text_output_page; ?></option>
                <?php } else { ?>
                <option value="0"><?php echo $text_output_page; ?></option>
                <?php }?>
                <?php if($config_live_update_output==1){?>
                <option value="1" selected><?php echo $text_output_popup; ?></option>
                <?php } else { ?>
                <option value="1"><?php echo $text_output_popup; ?></option>
                <?php }?>
                <?php if($config_live_update_output==2){?>
                <option value="2" selected><?php echo $text_output_both; ?></option>
                <?php } else { ?>
                <option value="2"><?php echo $text_output_both; ?></option>
                <?php }?>
            <?php }?>
          </select></span>
          <h2 class="success"><?php echo $entry_price; ?></h2>
            <table class="form">
                <tr>
                  <td width="35%"><?php echo $entry_live_update_price; ?></td>
                    <td width="15%">
                                <input type="radio" name="config_live_update_price" value="1" <?php if($config_live_update_price==1){ echo "checked";}?> /><?php echo $text_yes; ?>
                                <input type="radio" name="config_live_update_price" value="0" <?php if($config_live_update_price==0){ echo "checked";}?> /><?php echo $text_no; ?>
                              </td>
                  <td width="35%"><?php echo $entry_live_update_price_with_qty; ?></td>
                  <td width="15%">
                <input type="radio" name="config_live_update_price_with_qty" value="1" <?php if($config_live_update_price_with_qty==1){ echo "checked";}?> /><?php echo $text_yes; ?>
                <input type="radio" name="config_live_update_price_with_qty" value="0" <?php if($config_live_update_price_with_qty==0){ echo "checked";}?> /><?php echo $text_no; ?>
                </td>
                </tr>
                <tr>
                  <td width="35%"><?php echo $entry_live_update_special_price; ?></td>
                    <td width="15%">
                                <input type="radio" name="config_live_update_special_price" value="1" <?php if($config_live_update_special_price==1){ echo "checked";}?> /><?php echo $text_yes; ?>
                                <input type="radio" name="config_live_update_special_price" value="0" <?php if($config_live_update_special_price==0){ echo "checked";}?> /><?php echo $text_no; ?>
                              </td>
                  <td width="35%"><?php echo $entry_live_update_special_price_with_qty; ?></td>
                  <td width="15%">
                <input type="radio" name="config_live_update_special_price_with_qty" value="1" <?php if($config_live_update_special_price_with_qty==1){ echo "checked";}?> /><?php echo $text_yes; ?>
                <input type="radio" name="config_live_update_special_price_with_qty" value="0" <?php if($config_live_update_special_price_with_qty==0){ echo "checked";}?> /><?php echo $text_no; ?>
                </td>
                </tr>
                <tr>
                  <td width="35%"><?php echo $entry_live_update_price_excluding_tax; ?></td>
                    <td width="15%">
                                <input type="radio" name="config_live_update_price_excluding_tax" value="1" <?php if($config_live_update_price_excluding_tax==1){ echo "checked";}?> /><?php echo $text_yes; ?>
                                <input type="radio" name="config_live_update_price_excluding_tax" value="0" <?php if($config_live_update_price_excluding_tax==0){ echo "checked";}?> /><?php echo $text_no; ?>
                              </td>
                  <td width="35%"><?php echo $entry_live_update_price_excluding_tax_with_qty; ?></td>
                  <td width="15%">
                <input type="radio" name="config_live_update_price_excluding_tax_with_qty" value="1" <?php if($config_live_update_price_excluding_tax_with_qty==1){ echo "checked";}?> /><?php echo $text_yes; ?>
                <input type="radio" name="config_live_update_price_excluding_tax_with_qty" value="0" <?php if($config_live_update_price_excluding_tax_with_qty==0){ echo "checked";}?> /><?php echo $text_no; ?>
                </td>
                </tr>
                <tr>
                  <td width="35%"><?php echo $entry_live_update_price_in_reward_points; ?></td>
                    <td width="15%">
                                <input type="radio" name="config_live_update_price_in_reward_points" value="1" <?php if($config_live_update_price_in_reward_points==1){ echo "checked";}?> /><?php echo $text_yes; ?>
                                <input type="radio" name="config_live_update_price_in_reward_points" value="0" <?php if($config_live_update_price_in_reward_points==0){ echo "checked";}?> /><?php echo $text_no; ?>
                              </td>
                  <td width="35%"><?php echo $entry_live_update_price_in_reward_points_with_qty; ?></td>
                  <td width="15%">
                <input type="radio" name="config_live_update_price_in_reward_points_with_qty" value="1" <?php if($config_live_update_price_in_reward_points_with_qty==1){ echo "checked";}?> /><?php echo $text_yes; ?>
                <input type="radio" name="config_live_update_price_in_reward_points_with_qty" value="0" <?php if($config_live_update_price_in_reward_points_with_qty==0){ echo "checked";}?> /><?php echo $text_no; ?>
                </td>
                </tr>
                <tr>
                  <td width="35%"><?php echo $entry_show_pricevalue_with_option; ?></td>
                  <td width="15%">
                <input type="radio" name="config_live_show_pricevalue_with_option" value="1" <?php if($config_live_show_pricevalue_with_option==1){ echo "checked";}?> /><?php echo $text_yes; ?>
                <input type="radio" name="config_live_show_pricevalue_with_option" value="0" <?php if($config_live_show_pricevalue_with_option==0){ echo "checked";}?> /><?php echo $text_no; ?>
                </td>
                  <td width="35%"><?php echo $entry_hide_prefix_of_option_value; ?></td>
                  <td width="15%">
                <input type="radio" name="config_live_hide_prefix_of_option_value" value="1" <?php if($config_live_hide_prefix_of_option_value==1){ echo "checked";}?> /><?php echo $text_yes; ?>
                <input type="radio" name="config_live_hide_prefix_of_option_value" value="0" <?php if($config_live_hide_prefix_of_option_value==0){ echo "checked";}?> /><?php echo $text_no; ?>
                </td>
                </tr>
            </table>
          <h2 class="success"><?php echo $entry_weight; ?></h2>
            <table class="form">    
                <tr>
                  <td width="35%"><?php echo $entry_show_weight; ?></td>
                  <td width="15%">
                <input type="radio" name="config_live_show_weight" value="1" <?php if($config_live_show_weight==1){ echo "checked";}?> /><?php echo $text_yes; ?>
                <input type="radio" name="config_live_show_weight" value="0" <?php if($config_live_show_weight==0){ echo "checked";}?> /><?php echo $text_no; ?>
                </td>
                  <td width="35%"><?php echo $entry_show_weight_decimal_place; ?></td>
                  <td width="15%">
                <input type="text" name="config_live_show_weight_decimal_place" size="1" value="<?php if($config_live_show_weight_decimal_place){echo $config_live_show_weight_decimal_place;}?>" />
                </td>
                </tr>
                <tr>
                    <td width="35%"><?php echo $entry_live_update_weight; ?></td>
                  <td width="15%">
                                <input type="radio" name="config_live_update_weight" value="1" <?php if($config_live_update_weight==1){ echo "checked";}?> /><?php echo $text_yes; ?>
                                <input type="radio" name="config_live_update_weight" value="0" <?php if($config_live_update_weight==0){ echo "checked";}?> /><?php echo $text_no; ?>
                              </td>
                    <td width="35%"><?php echo $entry_live_update_weight_with_qty; ?></td>
                  <td width="15%">
                <input type="radio" name="config_live_update_weight_with_qty" value="1" <?php if($config_live_update_weight_with_qty==1){ echo "checked";}?> /><?php echo $text_yes; ?>
                <input type="radio" name="config_live_update_weight_with_qty" value="0" <?php if($config_live_update_weight_with_qty==0){ echo "checked";}?> /><?php echo $text_no; ?>
                </td>
                </tr>
                <tr>
                  <td width="35%"><?php echo $entry_show_option_weight; ?></td>
                  <td width="15%">
                <input type="radio" name="config_live_show_option_weight" value="1" <?php if($config_live_show_option_weight==1){ echo "checked";}?> /><?php echo $text_yes; ?>
                <input type="radio" name="config_live_show_option_weight" value="0" <?php if($config_live_show_option_weight==0){ echo "checked";}?> /><?php echo $text_no; ?>
                </td>
                  <td width="35%"><?php echo $entry_hide_prefix_of_option_weight; ?></td>
                  <td width="15%">
                <input type="radio" name="config_live_hide_prefix_of_option_weight" value="1" <?php if($config_live_hide_prefix_of_option_weight==1){ echo "checked";}?> /><?php echo $text_yes; ?>
                <input type="radio" name="config_live_hide_prefix_of_option_weight" value="0" <?php if($config_live_hide_prefix_of_option_weight==0){ echo "checked";}?> /><?php echo $text_no; ?>
                </td>
                </tr>
            </table>
          <h2 class="success"><?php echo $entry_point; ?></h2>
            <table class="form">    
                <tr>
                    <td width="35%"><?php echo $entry_live_update_points; ?></td>
                  <td width="15%">
                <input type="radio" name="config_live_update_points" value="1" <?php if($config_live_update_points==1){ echo "checked";}?> /><?php echo $text_yes; ?>
                <input type="radio" name="config_live_update_points" value="0" <?php if($config_live_update_points==0){ echo "checked";}?> /><?php echo $text_no; ?>
                </td>
                  <td width="35%">&nbsp;</td>
                  <td width="15%">&nbsp;</td>
                </tr>
                <tr>
                  <td width="35%"><?php echo $entry_show_option_point; ?></td>
                  <td width="15%">
                <input type="radio" name="config_live_show_option_point" value="1" <?php if($config_live_show_option_point==1){ echo "checked";}?> /><?php echo $text_yes; ?>
                <input type="radio" name="config_live_show_option_point" value="0" <?php if($config_live_show_option_point==0){ echo "checked";}?> /><?php echo $text_no; ?>
                </td>
                  <td width="35%"><?php echo $entry_hide_prefix_of_option_point; ?></td>
                  <td width="15%">
                <input type="radio" name="config_live_hide_prefix_of_option_point" value="1" <?php if($config_live_hide_prefix_of_option_point==1){ echo "checked";}?> /><?php echo $text_yes; ?>
                <input type="radio" name="config_live_hide_prefix_of_option_point" value="0" <?php if($config_live_hide_prefix_of_option_point==0){ echo "checked";}?> /><?php echo $text_no; ?>
                </td>
                </tr>
            </table>
          <h2 class="warning"><?php echo $entry_discount; ?>  <strong><em>-- Under Development - Coming Soon.</em></strong> </h2>
            <table class="form">    
                <tr>
                  <td width="35%"><?php echo $entry_live_update_discount; ?></td>
                  <td width="15%">
                <input name="s" type="radio" disabled value="0" /><?php echo $text_yes; ?>
                <input name="s" type="radio" disabled value="0" /><?php echo $text_no; ?>
                </td>
                  <td width="35%">&nbsp;</td>
                  <td width="15%">&nbsp;</td>
                </tr>
        ...
        <div id="tab-option">
          ...
          <table class="form">
            ...
            <tr>
              <td><span class="required">*</span> <?php echo $entry_related_limit; ?></td>
              <td><input type="text" name="config_related_limit" value="<?php echo $config_related_limit; ?>" size="3" />
                <?php if ($error_related_limit) { ?>
                <span class="error"><?php echo $error_related_limit; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
        ...
        <div id="tab-image">
          <table class="form">
            ...
            <tr>
              <td><span class="required">*</span> <?php echo $entry_icon_image_category; ?></td>
              <td><input type="text" name="config_icon_image_category_width" value="<?php echo $config_icon_image_category_width; ?>" size="3" />
                x
                <input type="text" name="config_icon_image_category_height" value="<?php echo $config_icon_image_category_height; ?>" size="3" />
                <?php if ($error_icon_image_category) { ?>
                <span class="error"><?php echo $error_icon_image_category; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
              <td><span class="required">*</span> <?php echo $entry_image_sub_category; ?></td>
              <td><input type="text" name="config_image_sub_category_width" value="<?php echo $config_image_sub_category_width; ?>" size="3" />
                x
