...
class ControllerModuleBanner extends Controller {
	...
	public function index() {   
		...
		$this->data['text_content_home_square'] = $this->language->get('text_content_home_square');
		$this->data['text_content_home_square_two'] = $this->language->get('text_content_home_square_two');
		$this->data['text_content_home_longtail'] = $this->language->get('text_content_home_longtail');
