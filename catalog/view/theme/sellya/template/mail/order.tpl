...
<div style="width: 680px;"><a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>"><img src="<?php echo $logo; ?>" alt="<?php echo $store_name; ?>" style="margin-bottom: 20px; border: none;" /></a>
  ...
  <table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
    <thead>
      <tr>
        <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; background-color: #EFEFEF; font-weight: bold; text-align: left; padding: 7px; color: #222222;" colspan="2"><?php echo $text_store_detail; ?></td>
      </tr>
    </thead>
    <tr>
      <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;">
        <b><?php echo $text_store_name; ?></b> <?php echo $store_name; ?> <br>
        <b><?php echo $text_store_address; ?></b> <?php echo $store_address; ?> <br>
        <b><?php echo $text_telephone; ?></b> <?php echo $store_telephone; ?> <br>
        <b><?php echo $text_email; ?></b> <?php echo $store_email; ?> <br>
        <b><?php echo $text_store_url; ?></b> <a href="<?php echo $store_url; ?>" target="_blank"><?php echo $store_url; ?></a> <br>
      </td>
      <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;">
        <b><?php echo $text_store_firma; ?></b> <?php echo $store_firma; ?> <br>
        <b><?php echo $text_store_cif; ?></b> <?php echo $store_cif; ?> <br>
        <b><?php echo $text_store_recom; ?></b> <?php echo $store_recom; ?> <br>
        <b><?php echo $text_store_banca; ?></b> <?php echo $store_banca; ?> <br>
        <b><?php echo $text_store_cont; ?></b> <?php echo $store_cont; ?> <br>
      </td>
    </tr>
  </table>
