          ...
          <div class="pbox">
            ...
            <?php if ($product['thumb']) { ?>
              <div class="image">
                ...
                <div class="promo-icon">Promotie</div>
          ...
          <?php 
            ...
            foreach ($products as $product) { 
              if (++$counter == 3) { ?>
                ...
                <li class="homebanner" id="homebanner1">
                    <?php echo $content_home_square; ?> 
                </li>

                <li class="homebanner" id="homebanner2">
                    <?php echo $content_home_square_two; ?> 
                </li>  
              ...
              elseif ($counter == 6) { ?>
                ...
                <li id="longBannerHome">
                    <?php echo $content_home_longtail; ?> 
                </li> 
                  ...
                  <div class="pbox">
                    ...
                    <?php if ($product['rating']) { ?>
                      <div class="rating hidden-phone hidden-tablet">
                        <img src="catalog/view/theme/sellya/image/stars/stars<?php 
                            echo $this->config->get('sellya_mid_prod_stars_color'); ?>-<?php 
                            echo $product['rating']; ?>.png" alt="<?php 
