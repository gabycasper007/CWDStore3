	...
	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <table class="form">
					...
					<tr>
                        ...
                        <div>
                            ...
                            <span class="sellya_help">5.&nbsp;</span><img src="<?php echo HTTP_CATALOG; ?>catalog/view/theme/sellya/image/icon_cart_5.png">                            
                        ...
                        <select name="sellya_top_area_cart_icon_style">                     
                           ...
                           <option value="5"<?php if($sellya_top_area_cart_icon_style == '5') echo ' selected="selected"';?>>5</option> 
        ...
        <table class="form sellya_sep">
                    ...
                    <tr>
                        ...
                        <td><?php echo $entry_payment_trusted; ?></td>

                        <td width="130">

                        <div style="margin-top:6px; float:left"><label class="s_checkbox">

                        <input type="checkbox" value="1" name="sellya_payment_trusted"<?php if($sellya_payment_trusted == '1') echo ' checked="checked"';?> /> Show</label>&nbsp;&nbsp;&nbsp;&nbsp;</div>

                        <div style="margin-top:0px;"><img src="<?php echo HTTP_CATALOG; ?>catalog/view/theme/sellya/image/payment/payment_image_trusted.png" border="0" alt="trusted" title="trusted"></div>

                        </td>

                        <td colspan="2">

                        <?php echo $entry_payment_url; ?>&nbsp;&nbsp;&nbsp;<input type="text" name="sellya_payment_trusted_url" value="<?php echo $sellya_payment_trusted_url; ?>" />
                    ...
                    <tr>
                        ...
                        <td><?php echo $entry_payment_verified_visa; ?></td>

                        <td width="130">

                        <div style="margin-top:6px; float:left"><label class="s_checkbox">

                        <input type="checkbox" value="1" name="sellya_payment_verified_visa"<?php if($sellya_payment_verified_visa == '1') echo ' checked="checked"';?> /> Show</label>&nbsp;&nbsp;&nbsp;&nbsp;</div>

                        <div style="margin-top:0px;"><img src="<?php echo HTTP_CATALOG; ?>catalog/view/theme/sellya/image/payment/payment_image_verified_visa.png" border="0" alt="verified_visa" title="verified_visa"></div>

                        </td>

                        <td colspan="2">

                        <?php echo $entry_payment_url; ?>&nbsp;&nbsp;&nbsp;<input type="text" name="sellya_payment_verified_visa_url" value="<?php echo $sellya_payment_verified_visa_url; ?>" />
                    ...
                    <tr>
                        ...
                        <td><?php echo $entry_payment_payu; ?></td>

                        <td width="130">

                        <div style="margin-top:6px; float:left"><label class="s_checkbox">

                        <input type="checkbox" value="1" name="sellya_payment_payu"<?php if($sellya_payment_payu == '1') echo ' checked="checked"';?> /> Show</label>&nbsp;&nbsp;&nbsp;&nbsp;</div>

                        <div style="margin-top:0px;"><img src="<?php echo HTTP_CATALOG; ?>catalog/view/theme/sellya/image/payment/payment_image_payu.png" border="0" alt="payu" title="payu"></div>

                        </td>

                        <td colspan="2">

                        <?php echo $entry_payment_url; ?>&nbsp;&nbsp;&nbsp;<input type="text" name="sellya_payment_payu_url" value="<?php echo $sellya_payment_payu_url; ?>" />
					...
					<tr>
                        ...
                        <td><?php echo $entry_payment_LibraPay; ?></td>

                        <td width="130">

                        <div style="margin-top:6px; float:left"><label class="s_checkbox">

                        <input type="checkbox" value="1" name="sellya_payment_LibraPay"<?php if($sellya_payment_LibraPay == '1') echo ' checked="checked"';?> /> Show</label>&nbsp;&nbsp;&nbsp;&nbsp;</div>

                        <div style="margin-top:0px;"><img src="<?php echo HTTP_CATALOG; ?>catalog/view/theme/sellya/image/payment/payment_image_LibraPay.png" border="0" alt="LibraPay" title="LibraPay"></div>

                        </td>

                        <td colspan="2">

                        <?php echo $entry_payment_url; ?>&nbsp;&nbsp;&nbsp;<input type="text" name="sellya_payment_LibraPay_url" value="<?php echo $sellya_payment_LibraPay_url; ?>" />
