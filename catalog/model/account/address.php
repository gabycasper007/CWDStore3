	...
	public function addAddress($data) {
		...
		if (!empty($data['default'])) {
			$this->db->query("UPDATE " . DB_PREFIX . 
				"customer SET address_id = '" . (int)$address_id . "' WHERE customer_id = '" . (int)$this->customer->getId() . 
			"'");
		}
	...
	public function getAddress($address_id) {
		...
		if ($address_query->num_rows) {
			...
			$address_data = array(
				...
				// 'reg_com'     => $address_query->row['reg_com'],
				// 'banca'     => $address_query->row['banca'],
				// 'cont'     => $address_query->row['cont'],
			);
