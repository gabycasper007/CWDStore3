    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
      ...
      <div class="content">
        ...
        <div class="row-fluid">
          ...
          <div class="span4 firma-dispaly">
            <?php // echo $entry_firma; ?>
            <input type="text" name="firma" value="<?php echo $firma; ?>" placeholder="<?php echo $entry_firma; ?>" />
        ...
        <div class="row-fluid">
          <div class="span4 cif-display">
            <?php // echo $entry_cif; ?>
            <input type="text" name="cif" value="<?php echo $cif; ?>" placeholder="<?php echo $entry_cif; ?>" />
            
            <?php // if ($error_tax_id) { ?>
            <!-- <span class="error"><?php echo $error_banca; ?></span> -->
            <?php // } ?>
          </div>
          <div class="span4 recom-display">
            <?php // echo $entry_recom; ?>
            <input type="text" name="recom" value="<?php echo $recom; ?>" placeholder="<?php echo $entry_recom; ?>" />
                      
            <?php // if ($error_tax_id) { ?>
            <!-- <span class="error"><?php echo $error_banca; ?></span> -->
            <?php // } ?>
          </div>
          <div class="span4 banca-display">
            <?php // echo $entry_banca; ?>
            <input type="text" name="banca" value="<?php echo $banca; ?>" placeholder="<?php echo $entry_banca; ?>" />
        ...
        <div class="row-fluid">
          <div class="span4 cont-display">            
            <?php // echo $entry_cont; ?>
            <input type="text" name="cont" value="<?php echo $cont; ?>" placeholder="<?php echo $entry_cont; ?>" />
