        ...
        <div id="tab-general">
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="text" name="config_firma" value="<?php echo $config_firma; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_cif; ?></td>
              <td><input type="text" name="config_cif" value="<?php echo $config_cif; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_recom; ?></td>
              <td><input type="text" name="config_recom" value="<?php echo $config_recom; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_banca; ?></td>
              <td><input type="text" name="config_banca" value="<?php echo $config_banca; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_cont; ?></td>
              <td><input type="text" name="config_cont" value="<?php echo $config_cont; ?>" /></td>
            </tr>
          </table>
        </div>
        <div id="tab-store">
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="text" name="config_slogan" value="<?php echo $config_slogan; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_mesaj; ?></td>
              <td><input type="text" name="config_mesaj" value="<?php echo $config_mesaj; ?>" /></td>
            </tr>
