	...
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			return array(
				...
				/*'payment_firma'           => $order_query->row['payment_firma'],
				'payment_cif'           => $order_query->row['payment_cif'],
				'payment_recom'           => $order_query->row['payment_recom'],
				'payment_banca'           => $order_query->row['payment_banca'],
				'payment_cont'            => $order_query->row['payment_cont'],*/
				...
				/*'shipping_firma'            => $order_query->row['shipping_firma'],
				'shipping_cif'            => $order_query->row['shipping_cif'],
				'shipping_recom'          => $order_query->row['shipping_recom'],
				'shipping_banca'          => $order_query->row['shipping_banca'],
				'shipping_cont'           => $order_query->row['shipping_cont'],*/
