...
class ControllerSettingStore extends Controller {
	...
	protected function getList() {
		...
		if (
			$this->config->get('searchanise_status') == 'A'
	...
	public function getForm() { 
		...
		} elseif (isset($store_info['config_firma'])) {
			$this->data['config_firma'] = $store_info['config_firma'];
		} else {
			$this->data['config_firma'] = '';
		}
		if (isset($this->request->post['config_cif'])) {
			$this->data['config_cif'] = $this->request->post['config_cif'];
		} elseif (isset($store_info['config_cif'])) {
			$this->data['config_cif'] = $store_info['config_cif'];
		} else {
			$this->data['config_cif'] = '';
		}
		if (isset($this->request->post['config_recom'])) {
			$this->data['config_recom'] = $this->request->post['config_recom'];
		} elseif (isset($store_info['config_recom'])) {
			$this->data['config_recom'] = $store_info['config_recom'];
		} else {
			$this->data['config_recom'] = '';
		}
		if (isset($this->request->post['config_banca'])) {
			$this->data['config_banca'] = $this->request->post['config_banca'];
		} elseif (isset($store_info['config_banca'])) {
			$this->data['config_banca'] = $store_info['config_banca'];
		} else {
			$this->data['config_banca'] = '';
		}
		if (isset($this->request->post['config_cont'])) {
			$this->data['config_cont'] = $this->request->post['config_cont'];
		} elseif (isset($store_info['config_cont'])) {
			$this->data['config_cont'] = $store_info['config_cont'];
		} else {
			$this->data['config_cont'] = '';
		}
		if (isset($this->request->post['config_slogan'])) {
			$this->data['config_slogan'] = $this->request->post['config_slogan'];
		} elseif (isset($store_info['config_slogan'])) {
			$this->data['config_slogan'] = $store_info['config_slogan'];
		} else {
			$this->data['config_slogan'] = '';
		}
		if (isset($this->request->post['config_mesaj'])) {
			$this->data['config_mesaj'] = $this->request->post['config_mesaj'];
		} elseif (isset($store_info['config_mesaj'])) {
			$this->data['config_mesaj'] = $store_info['config_mesaj'];
		} else {
			$this->data['config_mesaj'] = '';
		}
