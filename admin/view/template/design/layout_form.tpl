        ...
        <table id="route" class="list">
          ...
          <tbody id="route-row<?php echo $route_row; ?>">
            <tr>
              ...
              <td class="left"><a onclick="$('#route-row<?php echo $route_row; ?>').remove();" class="button button-caution"><?php echo $button_remove; ?></a></td>
            </tr>
          </tbody>
          <?php $route_row++; ?>
          <?php } ?>
...
function addRoute() {
	...
	html += '    <td class="left"><a onclick="$(\'#route-row' + route_row + '\').remove();" class="button button-caution"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
	html += '</tbody>';
