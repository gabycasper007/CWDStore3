...
class ControllerCommonFooter extends Controller {
	protected function index() {
		...
		$this->data['text_enter_account'] = $this->language->get('text_enter_account');
		...
		$this->data['tech'] = $this->config->get('config_tech');
		$this->data['infoline'] = $this->config->get('config_infoline');
		$this->data['text_marimi'] = $this->language->get('text_marimi');
		$this->data['text_address'] = $this->language->get('text_address');
		$this->data['text_livare'] = $this->language->get('text_livare');
