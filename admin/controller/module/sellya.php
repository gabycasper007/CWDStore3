...
class ControllerModuleSellya extends Controller {
	...
	public function index() {
        ...
        'sellya_payment_trusted',
        'sellya_payment_trusted_url',
        'sellya_payment_verified_visa',
        'sellya_payment_verified_visa_url',
        'sellya_payment_payu',
        'sellya_payment_payu_url',
        'sellya_payment_LibraPay',
        'sellya_payment_LibraPay_url',
