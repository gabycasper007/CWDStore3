...
<div id="content">
  ...
  <?php } ?>	
    ...
    <div class="heading">
      ...
      <div class="buttons"><a onclick="$('#form').submit();" class="button"><?php echo $button_save; ?></a><a onclick="location = '<?php echo $cancel; ?>';" class="button button-caution"><?php echo $button_cancel; ?></a></div>
    </div><!-- end of .heading -->
			...
			<tr>
				...
				<?php foreach($super_seo_urls as $url) { ?>
					<tr>
						...
						<td><a href = "<?php echo $url['delete']; ?>" class = "button button-caution"><?php echo $button_delete; ?></a></td>
					</tr>
				<?php } ?>
				</tbody>
			</table>
