...
class ControllerSaleOrder extends Controller {
	private $error = array();
  	...
  	public function getForm() {
		...
		if (isset($this->error['firma'])) {
			$this->data['error_firma'] = $this->error['firma'];
		} else {
			$this->data['error_firma'] = '';
		}
		...
		if (isset($this->error['recom'])) {
			$this->data['error_recom'] = $this->error['recom'];
		} else {
			$this->data['error_recom'] = '';
		}
		...
		if (isset($this->error['cont'])) {
			$this->data['error_cont'] = $this->error['cont'];
		} else {
			$this->data['error_cont'] = '';
		}
    	...
    	if (isset($this->request->post['firma'])) {
			...
			$this->data['firma'] = $order_info['firma'];
		} else {
      		$this->data['firma'] = '';
    	}	
    	if (isset($this->request->post['cif'])) {
			...
			$this->data['cif'] = $order_info['cif'];
		} else {
      		$this->data['cif'] = '';
    	}	
    	if (isset($this->request->post['recom'])) {
      		$this->data['recom'] = $this->request->post['recom'];
    	} elseif (!empty($order_info)) { 
			$this->data['recom'] = $order_info['recom'];
		} else {
      		$this->data['recom'] = '';
    	}	
    	if (isset($this->request->post['banca'])) {
			...
			$this->data['banca'] = $order_info['banca'];
		} else {
      		$this->data['banca'] = '';
    	}	
    	if (isset($this->request->post['cont'])) {
      		$this->data['cont'] = $this->request->post['cont'];
    	} elseif (!empty($order_info)) { 
			$this->data['cont'] = $order_info['cont'];
		} else {
      		$this->data['cont'] = '';
    	}	
	...
	public function info() {
		...
		if ($order_info) {
			...
			$this->data['text_store_firma'] = $this->language->get('text_firma');
			$this->data['text_store_cif'] = $this->language->get('text_cif');
			$this->data['text_store_recom'] = $this->language->get('text_recom');
			$this->data['text_store_banca'] = $this->language->get('text_banca');			
			$this->data['text_store_cont'] = $this->language->get('text_cont');
			...
			$this->data['text_firma'] = $this->language->get('text_firma');
			$this->data['text_cif'] = $this->language->get('text_cif');
			$this->data['text_recom'] = $this->language->get('text_recom');
			$this->data['text_banca'] = $this->language->get('text_banca');			
			$this->data['text_cont'] = $this->language->get('text_cont');
			...
			$this->data['store_firma'] = $order_info['store_firma'];
			$this->data['store_cif'] = $order_info['store_cif'];
			$this->data['store_recom'] = $order_info['store_recom'];
			$this->data['store_banca'] = $order_info['store_banca'];
			$this->data['store_cont'] = $order_info['store_cont'];
		...
		foreach ($orders as $order_id) {
			...
			if ($order_info) {
				...
				if ($store_info) {
					...
					/*$store_firma = $store_info['config_firma'];
					$store_cif = $store_info['config_cif'];
					$store_recom = $store_info['config_recom'];
					$store_banca = $store_info['config_banca'];
					$store_cont = $store_info['config_cont'];*/
					...
					/*$store_firma = $this->config->get('config_firma');
					$store_cif = $this->config->get('config_cif');
					$store_recom = $this->config->get('config_recom');
					$store_banca = $this->config->get('config_banca');
					$store_cont = $this->config->get('config_cont');*/
				}
				...
				$this->data['orders'][] = array(
					...
					'store_firma'          => $order_info['store_firma'],
					'store_cif'          => $order_info['store_cif'],
					'store_recom'          => $order_info['store_recom'],
					'store_banca'          => $order_info['store_banca'],
					'store_cont'          => $order_info['store_cont'],
					...
					/*'store_firma'        => $store_firma,
					'store_cif'          => $store_cif,
					'store_recom'        => $store_recom,
					'store_banca'        => $store_banca,
					'store_cont'         => $store_cont,*/

					'email'              => $order_info['email'],
					'telephone'          => $order_info['telephone'],

					'firma'          	 => $order_info['firma'],
					'cif'          		 => $order_info['cif'],
					'recom'          	 => $order_info['recom'],
					'banca'          	 => $order_info['banca'],
					'cont'          	 => $order_info['cont'],
